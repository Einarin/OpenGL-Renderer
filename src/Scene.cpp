...
namespace gl {
	...
	void Scene::loadDemo(AssetManager& assetManager) {
		...
		m_models[4].modelName = "assets/MakeHuman/assassin.obj";
		...
		m_models[7].localTransform = rotate(translate(mat4(), vec3(-25.f, -10.f, 5.f)), 180.f, vec3(0.f, 1.f, 0.f));
		m_models[7].modelName = "assets/MakeHuman/sundress.fbx";
		m_models[7].model = assetManager.loadModel(m_models[7].modelName);
		m_models[8].localTransform = rotate(translate(mat4(), vec3(-25.f, 10.f, 5.f)), 180.f, vec3(0.f, 1.f, 0.f));
		m_models[8].modelName = "assets/MakeHuman/man.obj";
		m_models[8].model = assetManager.loadModel(m_models[8].modelName);
		m_didLoad = true;
	}
